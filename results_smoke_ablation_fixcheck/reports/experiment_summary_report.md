...
**Generated**: 2026-03-09 12:47:34

---

## Experiments Completed

- **ABLATION_COMPREHENSIVE**: 9 data points
- **AGGREGATION**: 0 data points

## Results Directory Structure

```
results_smoke_ablation_fixcheck/
results_smoke_ablation_fixcheck/
...
open results_smoke_ablation_fixcheck/visualizations/*.html  # macOS
xdg-open results_smoke_ablation_fixcheck/visualizations/*.html  # Linux
```
...
conv = safe_read_csv('results_smoke_ablation_fixcheck/analysis/convergence_rates.csv')
if conv is None:
...
stats = safe_read_csv('results_smoke_ablation_fixcheck/analysis/statistical_comparison.csv')
if stats is None:
...
mnist = safe_read_csv('results_smoke_ablation_fixcheck/experiments/mnist/MNIST_MLP_Adam_seed42.csv')
if mnist is None:
...
---
*Report generated by GDSearch v1.0 on 2026-03-09 12:47:34*
