...
This test file ensures that important fixes remain in place
and do not regress in future code changes.
...
def test_auto_lr_call_signature():
    ...
    Issue: HF NLP Auto-LR was calling with positional args
...
def test_sam_closure_requirement():
    ...
    Issue: Batch ablation was calling SAM.step() without closure.
...
def test_convergence_validation_signature():
    ...
    Issue: Orchestrator was passing unsupported keyword arguments
...
def test_performance_profiler_print_summary():
    ...
    Issue: print_summary() method was missing entirely.
...
def test_hf_nlp_validation_split():
    ...
    Issue: NLP path was using test set for early stopping,
