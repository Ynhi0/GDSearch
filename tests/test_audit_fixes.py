...
class TestAuditFix1_TestLeakageEnforcement:
    ...
    def test_untagged_loader_with_test_dataset_rejected(self):
        """AUDIT FIX 1: Untagged loader referencing test dataset must be rejected."""
    ...
    def test_properly_tagged_validation_loader_accepted(self):
        """AUDIT FIX 1: Properly tagged validation loader should pass checks."""
        from src.core.optuna_tuner import OptunaHyperparameterTuner
...
class TestAuditFix2_OptunaStudyContamination:
    ...
    def test_study_creation_defaults_to_no_reuse(self):
        """AUDIT FIX 2: Study creation should default to load_if_exists=False."""
        import optuna
        from src.core.optuna_tuner import OptunaHyperparameterTuner
...
class TestAuditFix3_SAM_OOM_Safety:
    ...
    def test_closure_optimizer_missing_attribute_caught(self):
        """AUDIT FIX 3: Missing requires_closure on SAM-like optimizer should raise."""
    ...
    def test_sam_wrapper_has_requires_closure(self):
        """AUDIT FIX 3: Verify SAMWrapper has requires_closure=True."""
...
class TestAuditFix4_AblationGuard:
    ...
    def test_ablation_script_requires_flag(self):
        """AUDIT FIX 4: Ablation script should require --allow-unfair-ablations flag."""
...
class TestAuditFix5_DDP_DeviceMapping:
    ...
    def test_local_rank_env_var_usage(self):
        """AUDIT FIX 5: DDP worker should use LOCAL_RANK env var when available."""
...
class TestAuditFix6_VenvNotTracked:
    ...
    def test_venv_in_gitignore(self):
        """AUDIT FIX 6: Verify venv/ is in .gitignore."""
