...
**Generated**: 2026-03-09 11:24:35

---

## Experiments Completed

- **HIGHDIM**: 18 data points
- **BETA_SENSITIVITY_TRAINING**: 4 data points
- **AGGREGATION**: 3 data points

## Results Directory Structure

```
results_smoke_kaggle_fixcheck/
results_smoke_kaggle_fixcheck/
...
open results_smoke_kaggle_fixcheck/visualizations/*.html  # macOS
xdg-open results_smoke_kaggle_fixcheck/visualizations/*.html  # Linux
```
...
conv = safe_read_csv('results_smoke_kaggle_fixcheck/analysis/convergence_rates.csv')
if conv is None:
...
stats = safe_read_csv('results_smoke_kaggle_fixcheck/analysis/statistical_comparison.csv')
if stats is None:
...
mnist = safe_read_csv('results_smoke_kaggle_fixcheck/experiments/mnist/MNIST_MLP_Adam_seed42.csv')
if mnist is None:
...
---
*Report generated by GDSearch v1.0 on 2026-03-09 11:24:35*
