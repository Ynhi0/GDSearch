...
open results_smoke_terminal_check/visualizations/*.html  # macOS
xdg-open results_smoke_terminal_check/visualizations/*.html  # Linux
```
...
conv = safe_read_csv('results_smoke_terminal_check/analysis/convergence_rates.csv')
if conv is None:
...
stats = safe_read_csv('results_smoke_terminal_check/analysis/statistical_comparison.csv')
if stats is None:
...
mnist = safe_read_csv('results_smoke_terminal_check/experiments/mnist/MNIST_MLP_Adam_seed42.csv')
if mnist is None:
...
---
*Report generated by GDSearch v1.0 on 2026-03-08 01:12:12*
