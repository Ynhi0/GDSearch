...
**Generated**: 2025-12-07 20:01:44

---

## 📊 Experiments Completed

- **MNIST**: 12 data points
- **AGGREGATION**: 12 data points
...
open /workspaces/GDSearch/results/visualizations/*.html  # macOS
xdg-open /workspaces/GDSearch/results/visualizations/*.html  # Linux
```
...
conv = pd.read_csv('/workspaces/GDSearch/results/analysis/convergence_rates.csv')
print(conv.groupby('optimizer')['convergence_rate'].mean())

# Load statistical comparison
stats = pd.read_csv('/workspaces/GDSearch/results/analysis/statistical_comparison.csv')
print(stats[stats['is_significant']])

# Load experiment data
mnist = pd.read_csv('/workspaces/GDSearch/results/experiments/mnist/MNIST_MLP_Adam_seed42.csv')
...
Multi-seed reproducible experiments with statistical rigor
```

---
*Report generated by GDSearch v1.0 on 2025-12-07 20:01:44*
