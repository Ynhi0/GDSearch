...
open results/visualizations/*.html  # macOS
xdg-open results/visualizations/*.html  # Linux
```
...
conv = pd.read_csv('results/analysis/convergence_rates.csv')
print(conv.groupby('optimizer')['convergence_rate'].mean())

# Load statistical comparison
stats = pd.read_csv('results/analysis/statistical_comparison.csv')
print(stats[stats['is_significant']])

# Load experiment data
mnist = pd.read_csv('results/experiments/mnist/MNIST_MLP_Adam_seed42.csv')
...
---
*Report generated by GDSearch v1.0 on 2025-12-07 02:52:23*
