...
**File**: `mnist_statistical_comparisons_benchmark.csv`
...
2. **Key files to examine**:
   - `mnist_statistical_comparisons_benchmark.csv`: Main results table
...
**Generated by**: GDSearch benchmark experiment suite
**Date**: 2025-11-03
