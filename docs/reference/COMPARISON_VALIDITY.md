...
>
> For example, in our CIFAR10 ResNet-18 benchmark:
...
> - **Neural Networks:** Figure 4.5 compares SGD/Adam/AdamW on ResNet-18 CIFAR10
>
...
> - Same dataset (CIFAR10, 50K train / 10K test)
...
**Incorrect Graph:**
```python
# X-axis: Epochs (1 epoch = 391 steps for CIFAR10)
...
# For CIFAR10: Epoch 10 = 3910 steps
...
> **Figure 4.2:** Training loss convergence for SGD on CIFAR10 ResNet-18.  
> **X-axis:** Iterations (k), not epochs. For CIFAR10 with batch size 128, 1 epoch = 391 iterations.  
