...
- NN Baselines (MNIST): `kaggle/mnist_benchmark/mnist_benchmark.py` (Kaggle-ready, multi-seed)
...
- MNIST benchmark stats: computed in `mnist_benchmark.py` and enriched by `scripts/generate_statistical_report.py`
...
- MNIST results: saved in `results/NN_SimpleMLP_MNIST_*_benchmark.csv`
- Ablation outputs:
...
- Kaggle-ready experiments: `kaggle/mnist_benchmark/`, `kaggle/cifar10_benchmark/`
