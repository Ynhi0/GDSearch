...
**CRITICAL DISTINCTION:** Results from 2D Rosenbrock (deterministic GD) and ResNet-18 CIFAR10 (mini-batch SGD) cannot be directly compared using the same theoretical framework.
```
...
# CIFAR10: 32×32×3 RGB images, 10 classes
```
...
>  
> 3.2 Neural Network Benchmarks (MNIST/CIFAR10)  
