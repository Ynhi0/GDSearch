...
### The Math:
For CIFAR-10 (50,000 images) with batch size 128:
```
...
```
"ResNet-18 reaches 92% accuracy after 90 epochs"  # = 35,190 steps for CIFAR-10
```
...
**A:** "Thank you for catching that. Figure X is intended for practical comparison (epochs), while Figure Y validates the O(1/√κ) theory using iteration count (1 epoch = 391 steps for CIFAR-10). I should clarify the axis units in the caption."
