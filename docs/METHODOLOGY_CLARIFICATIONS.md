...
> - CIFAR-10 (ResNet-18): B = 128 (391 steps/epoch for 50K training samples)
...
> 3. **Memory constraints:** ResNet-18 with B=256 exceeds 16GB GPU memory on CIFAR-10
>
...
**Check:** Verify that `create_separate_plots.py` does NOT generate distance-to-optimum plots for ResNet-18/MNIST/CIFAR-10.
...
> "Training loss vs. epochs for ResNet-18 on CIFAR-10. Note: 'Distance to optimum' cannot be computed for neural networks as the global minimum is unknown; training loss serves as the convergence proxy."
...
> - CIFAR-10: 40K train / 10K val (from official 50K train) / 10K test (official test split)
...
1. **Batch Size:** "We use B=128 for CIFAR-10 (391 steps/epoch)."
